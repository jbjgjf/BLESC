          ...
          <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/90 backdrop-blur">
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between text-white">
              ...
              <nav className="flex items-center gap-8 text-sm text-slate-300">
                ...
                <Link href="/timeline" className="flex items-center gap-1 hover:text-cyan-300 transition-colors">
                  <LineChart className="w-4 h-4" />
                  <span>Timeline</span>
                </Link>
                <Link href="/insights" className="flex items-center gap-1 hover:text-cyan-300 transition-colors">
