  ...
  return (
    <div className="bl-wrap bl-stack">
      <header className={styles.head}>
        ...
        <div>
          <h1 className="bl-h1">{t.guardian.title(view.studentName)}</h1>
      ...
      <section className="bl-card bl-rise">
        <div className="bl-card-head">
          ...
          <h2 className="bl-h2">{t.guardian.submissionTitle}</h2>
        </div>

        <div className="bl-grid bl-grid--3">
          <div className={styles.stat}>
            <span className="bl-num">{view.stats.streak}</span>
            <span className="bl-meta">{t.guardian.statStreak}</span>
          </div>
          <div className={styles.stat}>
            <span className="bl-num">{view.stats.weekCount}</span>
            <span className="bl-meta">{t.guardian.statWeek}</span>
          </div>
          <div className={styles.stat}>
            <span className="bl-num">{Math.round(view.stats.monthRate * 100)}%</span>
            <span className="bl-meta">{t.guardian.statMonthRate}</span>
          </div>
        </div>
        ...
        <p className="bl-micro" style={{ marginTop: 14 }}>
          {t.guardian.lastSubmitted(relativeDays(view.stats.lastSubmitted))}
        </p>
      </section>
      ...
      <section className="bl-card bl-rise">
        <div className="bl-card-head">
          ...
          <h2 className="bl-h2">{t.guardian.moodTitle}</h2>
          <span className="bl-chip bl-chip--tint">
            <Icon name="check" size={14} />
            {t.guardian.moodConsented}
          </span>
        </div>
      ...
      <section className="bl-card bl-rise">
        <div className="bl-card-head">
          ...
          <h2 className="bl-h2">{t.guardian.noticesTitle}</h2>
        </div>
      ...
      <section className="bl-card bl-rise">
        <div className="bl-card-head">
          ...
          <h2 className="bl-h2">{t.guardian.hiddenTitle}</h2>
        </div>
        <p className="bl-body" style={{ marginBottom: 14 }}>
          {t.guardian.hiddenIntro}
        </p>
        <ul className={styles.hidden}>
          {t.guardian.hidden.map((item) => (
            <li key={item}>
