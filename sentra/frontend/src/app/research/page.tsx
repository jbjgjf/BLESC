...
const journalSteps = ["記録を保存しています", "関係を抽出しています", "変化の大きさを計算しています", "研究用データを更新しています", "Done"];
const chatSteps = ["メッセージを準備しています", "関連する記録を探しています", "参照資料を確認しています", "慎重に応答を作成しています", "Done"];
    ...
    >
      ...
      <section style={panel} className="mb-8">
        ...
        >
          ...
          <div className="mt-1">
            <div className="inscription mb-2">今日の記録</div>
            <h1
            ...
            <p className="mt-1 text-sm" style={{ color: "var(--ink-mid)", fontStyle: "italic" }}>
              短いメモを2つ書くだけで大丈夫です。研究用のメタデータは、記録の裏側で透明に保存されます。
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-7 py-6 space-y-4">
          <div>
            <div className="mb-2 flex items-center justify-between gap-3">
              <label className="inscription block" htmlFor="journal-entry">日誌</label>
              <VoiceInputButton
            ...
            <textarea
              ...
              placeholder="今日あったこと、感じたこと、印象に残ったことを書いてください。"
              value={journalText}
          ...
          <div>
            <div className="mb-2 flex items-center justify-between gap-3">
              <label className="inscription block" htmlFor="first-recall">30秒の想起</label>
              <VoiceInputButton
                disabled={isSubmitting}
            ...
            <textarea
              ...
              placeholder="深く考えずに、直前の30秒で最初に思い浮かんだことを書いてください。"
              value={recallText}
        ...
        <section style={panel} className="mb-8">
          ...
          {topNodes.length > 0 && (
            <div className="px-7 py-5">
              <div className="inscription mb-3">主な抽出結果</div>
            ...
            <div className="px-7 py-5" style={{ borderTop: "1px solid var(--limestone)" }}>
              <div className="mb-3 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="inscription">ふりかえりカード</div>
                </div>
      ...
      >
        <div>
          <div className="inscription mb-1">関係グラフ</div>
          <div
            className="text-base"
      ...
      <section style={panel} className="mb-8">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="inscription">30回のふりかえり</div>
          </div>
        ...
        <form onSubmit={handleChatSubmit} className="px-7 py-5 space-y-3">
          <textarea
            ...
            placeholder="最近の傾向について、blescに聞いてみてください。"
            value={chatText}
          ...
          <div className="flex items-center justify-between gap-4">
            <span className="text-xs" style={{ color: "var(--ink-faint)", fontStyle: "italic" }}>
              チャットの内容は利用者のデータとして扱われ、外部のベクトルストアには送信されません。
            </span>
            <div className="flex items-center gap-2">
              <VoiceInputButton
                disabled={isChatSubmitting}
          ...
          {chatResponse?.answer && (
            ...
            >
              ...
              <div className="mt-3 text-xs" style={{ color: "var(--ink-faint)", fontStyle: "italic" }}>
                参照元： {Object.entries((chatResponse.retrieval_context.retrieval_sources as Record<string, unknown> | undefined) ?? {})
      ...
      {/* ── Recent entries ─────────────────────────────────────── */}
      <section>
        <div className="inscription mb-4">最近の記録</div>
