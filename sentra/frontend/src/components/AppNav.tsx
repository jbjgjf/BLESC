...
export function AppNav() {
  ...
  const items = (context === "educator" ? EDUCATOR_NAV : context === "guardian" ? GUARDIAN_NAV : STUDENT_NAV)
    .filter((item) => demo || !DEMO_ONLY_NAV_PATHS.has(item.href));
