...
export const ja = {
  ...
  resetPassword: {
    title: "新しいパスワードを設定",
    intro: "新しいパスワードを入力してください。設定するとそのままログインします。",
    newPassword: "新しいパスワード",
    confirmPassword: "確認のためもう一度",
    submit: "パスワードを設定する",
    ...
    /**
     * リンクが使えない理由は複数あるが、生徒に見せる文言は1つにまとめている。
     * 「期限切れ」と「別の端末で開いた」を区別して伝えても、どちらの場合も
     * やることは同じ（もう一度送る／担当者に言う）で、区別は不安を足すだけ。
     */
    linkUnusable:
      "このリンクは使えませんでした。期限が切れているか、リンクを送ったときとは違う端末やブラウザで開いた可能性があります。もう一度お試しいただくか、学校の担当者に連絡してください。",
    requestAgain: "もう一度送る",
  },
  ...
  login: {
    ...
    /**
     * 送信後は、そのアドレスが登録済みかどうかに関わらず同じ文言を返す。
     * 「このアドレスは登録されていません」は親切に見えて、誰が参加しているかを
     * 外から総当たりで確かめられる窓になる。参加者が未成年である以上、
     * 在籍を漏らさないほうを優先する。
     */
    resetSent:
      "入力されたメールアドレスが登録されていれば、再設定用のリンクを送りました。メールが届かないときは、迷惑メールフォルダを確認するか、学校の担当者に連絡してください。",
    resetHelpdesk:
      "メールを受け取れない場合は、学校の担当者に連絡してください。担当者から再設定の手続きができます。",
    error: {
      ...
      generic: "ログインまたは登録に失敗しました。少し時間をおいてもう一度お試しください。",
    },
  },
